...
export const SkipNextIcon = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
  </svg>
);

export const SkipPrevIcon = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const VolumeIcon = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M6.343 6.343a1 1 0 000 1.414L8.586 10H5a1 1 0 00-1 1v2a1 1 0 001 1h3.586l-2.243 2.243a1 1 0 101.414 1.414L10 15.414V18a1 1 0 001 1h2a1 1 0 001-1v-2.586l2.243 2.243a1 1 0 001.414-1.414L15.414 14H19a1 1 0 001-1v-2a1 1 0 00-1-1h-3.586l2.243-2.243a1 1 0 00-1.414-1.414L14 8.586V6a1 1 0 00-1-1h-2a1 1 0 00-1 1v2.586L7.757 6.343a1 1 0 00-1.414 0z" />
  </svg>
);
...
export const VinylIcon = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const QueueIcon = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l3-2v12l-3-2" />
  </svg>
);
...
export const SpeakerIcon = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path d="M5 9v6h4l5 4V5l-5 4H5z" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M16 8.8a4 4 0 010 6.4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M18.5 6a7 7 0 010 12" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
